...
async function main() {
	...
	if (args.includes("--help") || args.includes("-h")) {
		console.log(`Usage: swarm [options]

		Options:
		--issue <n>          Run only this issue and its sub-issues
		--label <name>       Issue label (default: swarm)
...
async function createPullRequest(results: WorkerResult[]) {
	...
	const url = await exec([
		...
		`feat: ${branch}`,
		"--body",
		`## Issues\n\n${issueList}\n\n🤖 Generated by [swarm](https://github.com/juicerq/swarm)`,
	]).catch(() => "");
